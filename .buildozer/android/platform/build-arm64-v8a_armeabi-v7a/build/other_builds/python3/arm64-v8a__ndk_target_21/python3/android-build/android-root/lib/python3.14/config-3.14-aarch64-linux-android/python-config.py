#!/home/hellomoto/igseek-app/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/other_builds/python3/arm64-v8a__ndk_target_21/python3/android-build/android-root/bin/python3.14
# -*- python -*-
